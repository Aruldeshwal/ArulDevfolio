...
// Handle CJS/ESM interop wrapper for react-countup
const CountUp = (typeof CountUpComponent === "function"
  ? CountUpComponent
  : (CountUpComponent as unknown as { default: React.ComponentType<{ duration?: number; suffix?: string; end?: number }> })?.default || CountUpComponent) as React.ComponentType<{ duration?: number; suffix?: string; end?: number }>;
